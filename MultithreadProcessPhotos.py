...
def process_file(this_file):
    ...
    this_fq_file = file_location + '/' + this_file
...
def main():
    if __name__ == '__main__':
        ...
        all_results = my_pool.imap(process_file, os.listdir(file_location))
        my_pool.close()
        my_pool.join()
...
parser.add_argument('--media', default=default_source_dir, help='Location of original image files. Default: {}'.format(default_source_dir))
